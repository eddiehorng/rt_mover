...
if __name__ == '__main__':
    ...
    today2040=datetime.datetime.combine(datetime.date.today(), datetime.datetime.min.time())+datetime.timedelta(hours=20,minutes=40,seconds=1)
    while True:
